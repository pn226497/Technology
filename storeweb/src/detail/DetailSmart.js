    ...
    <div className='row'>
          ...
          <Card style={{ margin: "30px 0" }}>
            <ListGroup variant="flush">
              <ListGroup.Item>
                ...
                <p><FontAwesomeIcon id="icon" icon={faArrowRotateRight} size="lg" /> Bảo hành có cam kết trong 12 tháng</p>
              </ListGroup.Item>
              <ListGroup.Item>

                <p><FontAwesomeIcon id="icon" icon={faBoxOpen} size="lg" /> Bộ sản phẩm gồm:Hộp, Đồng hồ, Sạc, Dây đeo dự phòng, Sách hướng dẫn</p>
              </ListGroup.Item>
              <ListGroup.Item>
                <p><i id="icon">< BsShieldCheck /></i> Bảo hành chính hãng 1 năm tại các trung tâm bảo hành hãng</p>
      ...
      <div className="col-lg-5 col-md-5 col-sm-6" >
        {data.products.smartwatch.map((data) => (
          data.id === param.detailId ?
            <div key={data.id}>
              <h2>Đồng hồ thông minh {data.name}</h2>
        ...
        <div style={{ marginTop: "30px" }}>
          <Card >
            ...
            <Card.Body>
              ...
              <ul>
                <li>Giảm 5% gói Bảo hiểm rơi vỡ</li>
